...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_se_net', action='store_true', default=True,
                        help='Enable SE-Net feature gating on NS tokens (default on)')
    parser.add_argument('--no_se_net', dest='use_se_net',
                        action='store_false',
                        help='Disable SE-Net feature gating')
    ...
    parser.add_argument('--use_ns_self_attn', action='store_true', default=True,
                        help='Enable self-attention among NS tokens within each '
                             'HyFormerBlock for feature crossing (default on)')
    parser.add_argument('--no_ns_self_attn', dest='use_ns_self_attn',
                        action='store_false',
                        help='Disable NS self-attention')
    ...
    parser.add_argument('--label_smoothing', type=float, default=0.05,
                        help='Label smoothing epsilon (0 = disabled, typical: 0.01~0.1)')
