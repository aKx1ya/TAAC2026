...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--save_top_k', type=int, default=1,
                        help='Keep at most K best checkpoints '
    ...
    # Sparse-Dense Pair Encoder options.
    parser.add_argument('--use_pair_cross_attn', action='store_true', default=True,
                        help='Enable lightweight cross-FID self-attention in '
                             'SparseDensePairEncoder (fids 62-66 interaction)')
    parser.add_argument('--no_pair_cross_attn', dest='use_pair_cross_attn',
                        action='store_false',
                        help='Disable cross-FID attention in pair encoder')
    parser.add_argument('--pair_dropout', type=float, default=0.0,
                        help='Dropout rate for cross-FID attention in pair encoder')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_pair_cross_attn": args.use_pair_cross_attn,
