# HyFormer-v0.3.1 — Hyformer + 1.a (Item 对数频次)
> 当前版本：**v0.3.1 · 1.a** | 基于 v0.3 baseline，仅添加了 Step 1a（Item 对数频次）
>
...
#### 1b. 贝叶斯平滑 CTR ❌ 不包含（此版本仅 1.a）

本版本未实现 1.b。如需贝叶斯平滑 CTR，请使用以下版本：
- `HyFormer-v0.3.1-Hyformer+1.b` — **仅 1.b**
