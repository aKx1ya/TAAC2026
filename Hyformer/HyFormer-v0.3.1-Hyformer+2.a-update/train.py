...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--kv_softmax_temperature', type=float, default=2.0,
                        help='Temperature scaling factor for KV weighted pooling softmax '
                             '(T=1.0 = original sharp softmax; T=2.0~3.0 = softened, '
...
def main() -> None:
    ...
    model_args = {
        ...
        "kv_softmax_temperature": args.kv_softmax_temperature,
    }
