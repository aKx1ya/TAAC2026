...
class PCVRParquetDataset(IterableDataset):
    ...
    def __init__(
        ...
        # ── Step 1b: resolve item_id offset and item_dense offset ──
        try:
        ...
        # ── Step 1b: Online Bayesian smoothed CTR computation ──
    ...
    def _load_schema(self, schema_path: str, seq_max_lens: Dict[str, int]) -> None:
        ...
        # ---- item_dense: Step 1b Bayesian smoothed CTR ----
    ...
    def _build_item_ctr_map(self) -> None:
        ...
        for file_path, rg_idx, _ in self._rg_list:
            ...
            # Count impressions and clicks per item_id
            ...
            # Count clicks (label_type == 1 means click)
